...
- The parser expects a **two-or-more-piece name**: `John Lennon`, `John Winston Ono Lennon`. Single-token strings fall outside this method's contract (use mononyms via the `mono` config flag, see [`mono`](../configuration.md#mono)).
