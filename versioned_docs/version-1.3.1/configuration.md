...
:::info Mononyms
v1.3.1 does **not** support single-token names (`Plato`, `Madonna`). They throw at construction. Mononym support arrived in v2 via a `mono` config flag — see [What's new in v2](./whats-new-in-v2.md) if you need it.
:::
